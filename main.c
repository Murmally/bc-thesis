...
void measure_libsodium_aes(int runs, char* message, char* key) {
    ...
    clock_t end = clock();
    print_output("Libsodium", runs, start, end);
}
...
void measure_rosetta_des(int runs) {
    ...
    for (int i = 0; i < runs; i++) { rosetta_main(message1, 16); }
    clock_t end1 = clock();
    print_output("rosetta DES - 128b", runs, start1, end1);

    clock_t start2 = clock();
    for (int i = 0; i < runs; i++) { rosetta_main(message2, 64); }
    clock_t end2 = clock();
    print_output("rosetta DES - 512b", runs, start2, end2);

    clock_t start3 = clock();
    for (int i = 0; i < runs; i++) { rosetta_main(message3, 256); }
    clock_t end3 = clock();
    print_output("rosetta DES - 2048b", runs, start3, end3);
}
