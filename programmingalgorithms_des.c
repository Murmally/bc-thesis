...
void KeySchedule(uint8_t key[], uint8_t schedule[][6], int isEncrypt)
{
...
void programmingalrorithms_des(char* message, char* key, int msgLen, int keyLen) {
    uint8_t text[16] = { 0x00,0x11,0x22,0x33,0x44,0x55,0x66,0x77,0x88,0x99,0xAA,0xBB,0xCC,0xDD,0xEE,0xFF };
    uint8_t customKey[64] = { 0x00,0x11,0x22,0x33,0x44,0x55,0x66,0x77,0x88,0x99,0xAA,0xBB,0xCC,0xDD,0xEE,0xFF,0x00,0x11,0x22,0x33,0x44,0x55,0x66,0x77,0x88,0x99,0xAA,0xBB,0xCC,0xDD,0xEE,0xFF,0x00,0x11,0x22,0x33,0x44,0x55,0x66,0x77,0x88,0x99,0xAA,0xBB,0xCC,0xDD,0xEE,0xFF,0x00,0x11,0x22,0x33,0x44,0x55,0x66,0x77,0x88,0x99,0xAA,0xBB,0xCC,0xDD,0xEE,0xFFF };
    uint8_t out[64];
    uint8_t schedule[16][6];

    // encrypt
    KeySchedule(customKey, schedule, 1);
    Crypt(text, out, schedule);
    PrintText(out);

    // decrypt
    KeySchedule(customKey, schedule, 0);
